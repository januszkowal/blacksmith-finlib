...
import org.blacksmith.finlib.accounting.register.RegisterProvider;
...
public class AccoutingTest {
  ...
  public void testDocument() throws JsonProcessingException {
    RegisterFactory rfac = new RegisterFactory(new RegisterProvider());

    Register preg = rfac.ofPosCcy(23L, "POSITION_BUY", Currency.EUR, Currency.PLN);

...
class CurveFactoryTest {
  ...
  public void shouldReturnKnots() {
    ...
    CurveDefinition definition = CurveDefinitionBuilder.builder()
        ...
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-1D", Tenor.TENOR_1D, quote("WIBOR-EUR-1D"), 0))
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-1W", Tenor.TENOR_1W, quote("WIBOR-EUR-1W"), 0))
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-2W", Tenor.TENOR_2W, quote("WIBOR-EUR-2W"), 0))
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-1M", Tenor.TENOR_1M, quote("WIBOR-EUR-1M"), 0))
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-3M", Tenor.TENOR_3M, quote("WIBOR-EUR-3M"), 0))
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-6M", Tenor.TENOR_6M, quote("WIBOR-EUR-6M"), 0))
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-1Y", Tenor.TENOR_1Y, quote("WIBOR-EUR-1Y"), 0))
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-3Y", Tenor.TENOR_3Y, quote("WIBOR-EUR-3Y"), 0))
        .nodes(SimpleCurveNodeDefinition.of("WIBOR-5Y", Tenor.TENOR_5Y, quote("WIBOR-EUR-5Y"), 0))
        .build();

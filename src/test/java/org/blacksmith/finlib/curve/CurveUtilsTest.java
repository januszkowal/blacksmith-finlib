...
public class CurveUtilsTest {
  ...
  public void indexSearch1() {
    ...
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 5d)).isEqualTo(2);
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 5.1d)).isEqualTo(2);
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 6d)).isEqualTo(2);
    ...
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 10d)).isEqualTo(3);
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 10.1d)).isEqualTo(3);
  }
  ...
  public void indexSearch2() {
    ...
    var knotsX = knots.stream().mapToDouble(Knot::getX).toArray();
    assertThat(AlgorithmUtils.getKnotIndex1(knotsX, 0.1d)).isEqualTo(0);
    assertThat(AlgorithmUtils.getKnotIndex1(knotsX, 1d)).isEqualTo(1);
    assertThat(AlgorithmUtils.getKnotIndex1(knotsX, 1.1d)).isEqualTo(1);
    assertThat(AlgorithmUtils.getKnotIndex1(knotsX, 2d)).isEqualTo(1);
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 3d)).isEqualTo(1);
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 4d)).isEqualTo(1);
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 5d)).isEqualTo(2);
    assertThat(AlgorithmUtils.getKnotIndex0(knotsX, 5.1d)).isEqualTo(2);

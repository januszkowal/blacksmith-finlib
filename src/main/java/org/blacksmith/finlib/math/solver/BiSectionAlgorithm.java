...
/**
 * Simple implementation of the Bisection method for finding roots or inverses of a function.
 * <p>
 * The function and its derivative must be supplied as instance of Function For examples of usage, see the source of the
 * test class or the Xirr class. The algorithm consists of repeatedly bisecting the interval defined within range: a <=
 * arg <= b If the value of the function at the candidate input is within the <code>tolerance</code> of the desired
 * target value, the method terminates.
 * <p>
...
public class BiSectionAlgorithm {
  ...
  /**
   * Convenience method for getting an instance of a {@link BiSectionSolverBuilder}.
   *
   * @return new Builder
   */

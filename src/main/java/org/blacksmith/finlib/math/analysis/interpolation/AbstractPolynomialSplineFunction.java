...
public class AbstractPolynomialSplineFunction {
  protected final double[] xValues;
  protected final PolynomialFunction[] polynomials;
  protected final int lastInterval;

  public AbstractPolynomialSplineFunction(double[] xValues, PolynomialFunction[] polynomials) {
...
//  }
//
//  public PolynomialSplineFunction1 polynomialSplineDerivative() {
//    PolynomialFunction[] derivativePolynomials = new PolynomialFunction[polynomials.length];
//    for (int i = 0; i < polynomials.length; i++) {
//      derivativePolynomials[i] = polynomials[i].polynomialDerivative();
//    }
//    return new PolynomialSplineFunction1(xValues, derivativePolynomials);
//  }

...
public class TempScheduleGenerator {
  private final Logger LOGGER = LoggerFactory.getLogger(TempScheduleGenerator.class);
  private final ScheduleParameters scheduleParameters;

  public TempScheduleGenerator(ScheduleParameters scheduleParameters) {
